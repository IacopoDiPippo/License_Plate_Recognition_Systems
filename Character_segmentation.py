...
from CCA_cleaning import plate_like_objects
...
# the next two lines is based on the assumptions that the width of a character in 
# a license plate should be between 5% and 15% of the license plate,
# and height  of a character should be between 35% and 60%
# this will eliminate some wrong guesses
